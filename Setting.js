...
global.owner = process.env.OWNER_NUMBER  || '94759504894' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://Vihanga:Nikiya0220@cluster0.ta2hzgz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.mztit = process.env.MZTIT ||"ᴍʀ.ɴɪᴋɪ",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://www.youtube.com/@InnoxentTech?sub_confirmation=1' ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/510bfc0c004d3a7a5eb7c.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '28_07_2024_SIGMA_MD_V1JXNhx7_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'ᴍʀ.ɴɪᴋɪʏᴀ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `ᴠɪʜᴀɴɢᴀ ʜᴀɴꜱᴀɴᴀ`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'ᴠɪʜᴀɴɢᴀ ʜᴀɴꜱᴀɴᴀ',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "ᴍʀ.ɴɪᴋɪʏᴀ" ,          // ADD YOUR STICKER PACKNAME
  ...
  caption :process.env.CAPTION || "*• ᴠɪʜᴀɴɢᴀ ʜᴀɴꜱᴀɴᴀ*\n*• ωнαтѕαρρ вσт* ",
